  ...
  return (
    <section id="about" className="section-padding bg-cream-light">
      <div className="container-max">
        <h2 className="text-4xl md:text-5xl font-serif text-charcoal text-center mb-12">
          About
        </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <h3 className="text-3xl md:text-4xl font-serif text-charcoal text-center mb-8">
            Collaborators
          </h3>
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-3">
                      <h4 className="text-xl font-serif text-charcoal pr-2">
                        {collaborator.name} 
                      </h4>
                      <button
                        onClick={(e) => {
                    ...
                    {isExpanded && (
                      <div className="mt-3 max-h-64 overflow-y-auto">
                        ...
                        {collaborator.link && (
                          <p className="text-terracotta hover:text-terracotta-dark underline transition-colors mt-3">
